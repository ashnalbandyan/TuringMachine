...
public class Test : MonoBehaviour
{
    ...
    int TuringMachinePlusNew(int x, int y)
    {
    ...
    int TuringMachineMinusNew(int x, int y)
    {
    ...
    int TuringMachineMultiplyNew(int x, int y)
    {
    ...
    int TuringMachineDivideNew(int x, int y)
    {
